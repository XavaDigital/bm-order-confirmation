...
export function ShareLinkPanel({
  ...
  // instead of asking for a click (David, 2026-08-04). Only when none exists:
  // regenerating would invalidate a link the customer may already hold.
  const autoGenerated = useRef(false);
  useEffect(() => {
    if (autoGenerated.current || hasToken || noGarments) return;
