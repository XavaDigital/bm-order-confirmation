...
import { generateRosterToken, getRosterMember } from '@/server/roster/service';
...
/**
 * Nudge a single pending roster member by email. Regenerates the shared
 * roster link (same tradeoff already accepted by "Regenerate link" and
 * "Email roster link" elsewhere on this tab: the old URL stops working).
 */
